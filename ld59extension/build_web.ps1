# Build script for the ld59extension GDExtension for Web (Emscripten).
#
...
Write-Info "=== ld59extension Web Build ==="
...
Write-Info "Output: addons\ld59extension\bin\"
Get-ChildItem -Path "..\addons\ld59extension\bin" -Filter "*.wasm" -ErrorAction SilentlyContinue |
