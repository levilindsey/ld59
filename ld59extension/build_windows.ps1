# Build script for the ld59extension GDExtension on Windows.
...
Write-Info "=== ld59extension Windows Build ==="
...
Get-ChildItem -Path "..\addons\ld59extension\bin" -Filter "*.dll" -ErrorAction SilentlyContinue |
